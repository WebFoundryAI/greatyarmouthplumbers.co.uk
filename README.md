...
1. Clone the repository:
   ```bash
   git clone https://github.com/WebFoundryAI/greatyarmouthplumbers.co.uk.git
   cd greatyarmouthplumbers.co.uk
   ```
...
4. Click **Save**
5. Site will be live at: `https://webfoundryai.github.io/greatyarmouthplumbers.co.uk/`
